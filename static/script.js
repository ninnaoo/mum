  ...
  obstacle.addEventListener("animationend", () => {
    if (!gameOver) {
      ...
      if (score >= finishScore) {gameOver = true;
        message.style.display = "flex";
        messageText.innerHTML = "<div class='gift'>Поздравляю с днем рождения! 🎂 Желаю крепкого здоровья, больших денежек, ярких улыбок и исполнения всех мечт! :р<div class='pictures'><img class='picture' src='static/hug.jpg'><img class='picture' src='static/dog.jpg'><img class='picture' src='static/congrat.jpg'></div></div>";
        restartBtn.style.display = "inline-block";
      }
    }
    obstacle.remove();
